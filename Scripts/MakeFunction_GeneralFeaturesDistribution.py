...
def GeneralFeatures_layout(pathVisual, pathVisualNEW, numberTE):   
	...
	f.write("from Functions import CommonDATA, CommonDATA_SelectTEs \n")
	f.write("from Functions import Couleur, GenomeBrowser, ChromosomeDistribution, GeneralFeatures\n\n\n")
	f.close()
